...
getProjectDetails( userData.userEmail);
...
getTaskDetails( userData.userEmail);
...
if (taskName ==="") {
    ...
    const data = {
        "taskName": taskName,
        "userAssigned": userData.userEmail,
    }
...
const userName1=document.querySelector(".assigned_user") as HTMLElement;
const userName2=document.querySelector(".assigned_user2") as HTMLElement;
const userName3=document.querySelector(".assigned_user3") as HTMLElement;
userName1.innerHTML = userData.userEmail
userName2.innerHTML = userData.userEmail
userName3.innerHTML = userData.userEmail
