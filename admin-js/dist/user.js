...
const userName1 = document.querySelector(".assigned_user");
const userName2 = document.querySelector(".assigned_user2");
const userName3 = document.querySelector(".assigned_user3");
